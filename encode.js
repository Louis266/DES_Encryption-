var button_encode = document.getElementById('encode_start');
var encode_content = document.getElementById('en_content');

button_encode.onclick = function () {
    encode_content.innerHTML = encode(document.getElementById('input_text').value,document.getElementById('input_key').value);
}
