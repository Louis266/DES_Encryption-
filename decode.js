...
button_decode.onclick = function () {
    decode_content.innerHTML = document.getElementById('input_text').value + document.getElementById('input_key').value;
}
...
function create_key(key){
    var sortedKey = new Array();
    var n;
    for(n=0;n<Key_table.length;n++){
        sortedKey.append()
    }
}
